...
int main(void)
{
  ...
  HAL_Delay(150);
  HAL_GPIO_WritePin(GPIOD, RED_Pin|BLUE_Pin|GREEN_Pin|ORANGE_Pin, GPIO_PIN_SET);
  HAL_Delay(200);
  HAL_GPIO_WritePin(GPIOD, RED_Pin|BLUE_Pin|GREEN_Pin|ORANGE_Pin, GPIO_PIN_RESET);
  HAL_Delay(500);
